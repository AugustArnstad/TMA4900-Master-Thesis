...
\vspace{7cm}
\noindent TMA4900 Masters thesis in Industrial Mathematics \\
...
\input{Chapters/00Sammendrag} %insert the chapter text from the files
...
\chapter{Methods}
\label{ch:method}
\input{Chapters/05Method_scribble.tex}
\cleardoublepage
...
\input{Chapters/08AppendixA}

\chapter{Bayesian Variable Importance usage}
\label{ap:bayesian-importance}
\input{Chapters/08AppendixB}

\chapter{Supplementary Material}
\label{ap:tables}
\input{Chapters/08AppendixC}

\chapter{Miscellaneous proofs}
\label{ap:proofs}
\input{Chapters/08AppendixD}
